...
public class RetrofitUtil {
    ...
    private RetrofitUtil(String baseUrl) {
        ...
        retrofit = new Retrofit.Builder()
                ...
                .addCallAdapterFactory(RxJavaCallAdapterFactory.create())//设置支持rxjava 注意是2
                .build();
    }
    ...
    public static RetrofitService getService() {
        return RetrofitUtil.getInstance(ApiService.Base).createService(RetrofitService.class);
    }
